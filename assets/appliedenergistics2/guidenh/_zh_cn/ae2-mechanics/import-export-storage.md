...
# “输入”与“输出”、“读取”与“写入”
在AE系统中，所有的“输入”与“输出”字样针对的对象都是AE网络本身，“输入”意为输入进AE网络，“输出”则是从AE网络中输出到外界。例如，ME输出总线的作用就是将AE网络的内容物输出到外界。

“读取”与“写入”的概念是以AE网络为主体，读取是AE网络读取他人，写入是AE网络写入他人，“只读”与“只写”同理。例如，当一个网络中的存储总线被设置为“只读”，马上该AE网络只能读取该存储总线的目标，不能将内容物放入其中，“只写”反之。
